...
nonlcon = @nonlineq_v2;
x = fmincon(@(x)power_SSS_v3_1_5sec(x),x0,A,b,Aeq,beq,lb,ub,nonlcon,options)
...
% % %     5*5^4   4*5^3 3*5^2;
% % %     20*5^3 12*5^2 6*5];
% % % xsss1 = [ thetaf(1,1) - x(1)*5^7 - x(2)*5^6;
% % %     -7*x(1)*5^6 - 6*x(2)*5^5;
% % %     42*x(1)*5^5 - 30*x(2)*5^4];
% % % xsss2 = [ thetaf(2,1) - x(3)*5^7 - x(4)*5^6;
% % %     -7*x(3)*5^6 - 6*x(4)*5^5;
% % %     42*x(3)*5^5 - 30*x(4)*5^4];
% % % xsss3= [ thetaf(3,1) - x(5)*5^7 - x(6)*5^6;
% % %     -7*x(5)*5^6 - 6*x(6)*5^5;
% % %     42*x(5)*5^5 - 30*x(6)*5^4];
% % % 
% % % xsss4 = [ thetaf(4,1) - x(7)*5^7 - x(8)*5^6;
% % %     -7*x(7)*5^6 - 6*x(8)*5^5;
% % %     42*x(7)*5^5 - 30*x(8)*5^4];
% % % xsss5 = [ thetaf(5,1) - x(9)*5^7 - x(10)*5^6;
% % %     -7*x(9)*5^6 - 6*x(10)*5^5;
% % %     42*x(9)*5^5 - 30*x(10)*5^4];
% % % %Bzsss = [csss;dsss;esss];
% % % Zsss1 = Asss\xsss1;
% % % Zsss2 = Asss\xsss2;
% % % Zsss3 = Asss\xsss3;
