...
t = [0:0.05:1.5]';
 ...
 i = 1;
Asss = [1.5^5 1.5^4 1.5^3;
    5*1.5^4   4*1.5^3 3*1.5^2;
    20*1.5^3 12*1.5^2 6*1.5];
xsss1 = [ thetaf(1,1)-thetat(1,1) - x(1)*1.5^7 - x(2)*1.5^6;
    -7*x(1)*1.5^6 - 6*x(2)*1.5^5;
    42*x(1)*1.5^5 - 30*x(2)*1.5^4];
xsss2 = [ thetaf(2,1)-thetat(2,1) - x(3)*1.5^7 - x(4)*1.5^6;
    -7*x(3)*1.5^6 - 6*x(4)*1.5^5;
    42*x(3)*1.5^5 - 30*x(4)*1.5^4];
xsss3= [ thetaf(3,1)-thetat(3,1) - x(5)*1.5^7 - x(6)*1.5^6;
    -7*x(5)*1.5^6 - 6*x(6)*1.5^5;
    42*x(5)*1.5^5 - 30*x(6)*1.5^4];

xsss4 = [ thetaf(4,1)-thetat(4,1) - x(7)*1.5^7 - x(8)*1.5^6;
    -7*x(7)*1.5^6 - 6*x(8)*1.5^5;
    42*x(7)*1.5^5 - 30*x(8)*1.5^4];
xsss5 = [ thetaf(5,1)-thetat(5,1) - x(9)*1.5^7 - x(10)*1.5^6;
    -7*x(9)*1.5^6 - 6*x(10)*1.5^5;
    42*x(9)*1.5^5 - 30*x(10)*1.5^4];
...
Q1=[x(1)*t.^7+x(2)*t.^6+Zsss1(1,1)*t.^5+Zsss1(2,1)*t.^4+Zsss1(3,1)*t.^3+thetat(1,1)]';
Q2=[x(3)*t.^7+x(4)*t.^6+Zsss2(1,1)*t.^5+Zsss2(2,1)*t.^4+Zsss2(3,1)*t.^3+thetat(2,1)]';
Q3=[x(5)*t.^7+x(6)*t.^6+Zsss3(1,1)*t.^5+Zsss3(2,1)*t.^4+Zsss3(3,1)*t.^3+thetat(3,1)]';
Q4=[x(7)*t.^7+x(8)*t.^6+Zsss4(1,1)*t.^5+Zsss4(2,1)*t.^4+Zsss4(3,1)*t.^3+thetat(4,1)]';
Q5=[x(9)*t.^7+x(10)*t.^6+Zsss5(1,1)*t.^5+Zsss5(2,1)*t.^4+Zsss5(3,1)*t.^3+thetat(5,1)]';
% size(Q1)
%%jotnt angle veloctty%%
Qd1=[7*x(1)*t.^6+6*x(2)*t.^5+5*Zsss1(1,1)*t.^4+4*Zsss1(2,1)*t.^3+3*Zsss1(3,1)*t.^2]';
Qd2=[7*x(3)*t.^6+6*x(4)*t.^5+5*Zsss2(1,1)*t.^4+4*Zsss2(2,1)*t.^3+3*Zsss2(3,1)*t.^2]';
Qd3=[7*x(5)*t.^6+6*x(6)*t.^5+5*Zsss3(1,1)*t.^4+4*Zsss3(2,1)*t.^3+3*Zsss3(3,1)*t.^2]';
Qd4=[7*x(7)*t.^6+6*x(8)*t.^5+5*Zsss4(1,1)*t.^4+4*Zsss4(2,1)*t.^3+3*Zsss4(3,1)*t.^2]';
Qd5=[7*x(9)*t.^6+6*x(10)*t.^5+5*Zsss5(1,1)*t.^4+4*Zsss5(2,1)*t.^3+3*Zsss5(3,1)*t.^2]';
% size(QZsss1(2,1))
%%jotnt angle acceleratton%%
Qdd1=[42*x(1)*t.^5+30*x(2)*t.^4+20*Zsss1(1,1)*t.^3+12*Zsss1(2,1)*t.^2+6*Zsss1(3,1)*t]';
Qdd2=[42*x(3)*t.^5+30*x(4)*t.^4+20*Zsss2(1,1)*t.^3+12*Zsss2(2,1)*t.^2+6*Zsss2(3,1)*t]';
Qdd3=[42*x(5)*t.^5+30*x(6)*t.^4+20*Zsss3(1,1)*t.^3+12*Zsss3(2,1)*t.^2+6*Zsss3(3,1)*t]';
Qdd4=[42*x(7)*t.^5+30*x(8)*t.^4+20*Zsss4(1,1)*t.^3+12*Zsss4(2,1)*t.^2+6*Zsss4(3,1)*t]';
Qdd5=[42*x(9)*t.^5+30*x(10)*t.^4+20*Zsss5(1,1)*t.^3+12*Zsss5(2,1)*t.^2+6*Zsss5(3,1)*t]';
...
Tt(:,i) = 10^-7*(Tm+Tc+Tb);
Power(i,1)= Tt(:,i)'*[(Qd1(1,i));(Qd2(1,i));(Qd3(1,i));(Qd4(1,i));(Qd5(1,i))];
P = abs(Power(i,1)) + P;
end
P
figure(1)
